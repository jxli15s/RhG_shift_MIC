function [Omega_k,Kx,Ky]=get_slab_Berrycurvature_dip2(obj,Kx,Ky,Enk,Unk,bandindex,nslab,delta,plottap)
...
%}                   
            ...
            qm=@MTB.ham.get_slab_quan_metric;            
            ...
            parfor l=1:itotal
                ...
                k=[Kx(i,j),Ky(i,j)];
                omega(l)=-2.*imag(qm(obj,k,dkx,dky,nslab,Unk(:,:,i,j),reshape(Enk(i,j,:),[dimH,1]),band,delta));
            end
