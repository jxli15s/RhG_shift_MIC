function [Unk,Enk,ham,vxk,vyk,vzk]=get_bulk_plane_kp_velocity_withH(pars,get_hk,nbands,Kx,Ky,Kz)
% Slove the Hamiltonian on the K-mesh 
    ...
    hamtem=zeros(dim_H,dim_H,itotal);
    ...
    parfor ll=1:itotal
          ...
          [Etem, psi,hk, vx, vy, vz] = slovek(k,pars,get_hk);  
          enktem(ll,:)  =Etem;
          unktem(:,:,ll)=psi;
          hamtem(:,:,ll)=hk;
          vxtem(:,:,ll) =vx;
