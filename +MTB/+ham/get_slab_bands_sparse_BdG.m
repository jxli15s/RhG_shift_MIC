function [Energy,kpath,kk]=get_slab_bands_sparse_BdG(hamiltonian,hopping_r,nslab,nbands,numEigs,nrpts,hkpoints,nk,a,b,mu,delta)
...
%    hkpoints2=zeros(length(hkpoints),2);
    ...
    Energy=zeros(numEigs,length(kpoints));
