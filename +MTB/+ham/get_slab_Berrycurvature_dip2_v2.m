function [Omega_k,Kx,Ky]=get_slab_Berrycurvature_dip2_v2(obj,del_index,Kx,Ky,Enk,Unk,bandindex,nslab,delta,plottap)
...
%}                   
            ...
            qm=@MTB.ham.get_slab_quan_metric_v2;            
            ...
            parfor l=1:itotal
                ...
                k=[Kx(i,j),Ky(i,j)];
                omega(l)=-2.*imag(qm(obj,del_index,k,dkx,dky,nslab,Unk(:,:,i,j),reshape(Enk(i,j,:),[dimH,1]),band,delta));
            end
